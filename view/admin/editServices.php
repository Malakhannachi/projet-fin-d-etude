...
<section id="hero-devis">    
    <h1 class="devis-hero">Modifier Services</h1>
    <p class="text-hero">Modifiez les services</p>
</section>

<section id="devis" class="devis-background1">
    <div class="devis-content">
        <h2 class="title-devis1">Mettez à jourle service</h2>
    ...
    <div class="form devis-background2">
        ...
        <form action="index.php?action=editServices&id=<?= htmlspecialchars( $service['id_Services']) ?>" method="post" class="formulaire" enctype="multipart/form-data">
            
            <div class="list">
                <label for="nom_Ser" class="label-devis">Nom de service</label>
                <input type="text" name="nom_Ser" id="nom_Ser" class="input" placeholder="nom" value="<?= htmlspecialchars($service['nom_Ser']) ?>">
            </div>
            <div class="list">
                ...
                <select name="id_Cat" id="id_Cat" class="select">
                    ...
                    <option value="<?php echo $cat['id_Cat'] ?>" <?php if ($service['id_Cat'] == $cat['id_Cat']) echo "selected" ?>><?php echo $cat['nom_Cat'] ?></option>
                    <?php endforeach; ?>
            ...
            <div class="list">
                ...
                <textarea name="description" id="description" rows="5" placeholder="description"><?= htmlspecialchars($service['description']) ?></textarea>
            </div>
            <div class="list">
